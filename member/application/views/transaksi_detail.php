                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if ($cekmidtrans['transaction_status']=="pending"): ?>
                            Segera lakukan pembayaran sebelum waktunya habis
                        <?php endif ?>
                    </td>
                </tr>
                <tr>
...
<!-- <h1><?php echo $snapToken ?></h1> -->
    <?php if (!empty($snapToken)): ?>
        <script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-X_dwp_rIucUe-s_a"></script>
    ...
    <form method="post">
        <div class="container">
            ...
            <?php foreach ($transaksi_detail as $k => $v ):?>
                ...
                <?php if (!empty($v['jumlah_rating'])): ?>
                    <h6><?php echo $v['nama_beli'] ?></h6>
                    <?php foreach (range(1, $v['jumlah_rating']) as $ky => $jum): ?>
